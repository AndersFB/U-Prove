 ...
 */
public final class IssuerParameters implements Serializable { // added Serializable because need to send IssuerParameters to ProverServlet
	// the parameters UID
    private byte[] parametersUID;

    // the prime order group
    private PrimeOrderGroup group; // added transient
