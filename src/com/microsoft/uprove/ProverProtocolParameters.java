...
public final class ProverProtocolParameters {
    ...
    /**
     * Constructs a <code>ProverProtocolParameters</code> instance.
     * @param numberOfTokens the number of wallets to issue.
	...
	/**
	 * Gets the number of wallets to issue.
	 * @return the number of wallets to issue.
	 */
    ...
    /**
     * Sets the number of wallets to issue.
     * @param numberOfTokens the number of wallets to issue.
