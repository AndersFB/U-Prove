...
<%
    ...
    String message = "Sorry, you are not old enough to rent a car.";

    if (attribute_age != null && Integer.parseInt(attribute_age) >= 18) {
        css = "success";
        headline = "Requirements fulfilled!";
        message = "You fulfill our requirements and are now able to rent a car.";
    }
...
<html>
<head>
    <title>Car rental (Verifier)</title>
...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Car rental (Verifier)</a>
        </div>
