...
<%
    ...
    String message = "Sorry, you have to be a danish citizenship and older than 18 years to vote.";

    if (attribute_age != null && Integer.parseInt(attribute_age) >= 18 &&
            attribute_citizenship != null && attribute_citizenship.toLowerCase().equals("danish")) {
        css = "success";
        headline = "Requirements fulfilled!";
        message = "You are able to vote because of your danish citizenship and age.";
    }
    ...
    if (attribute_citizenship != null)
        receivedAttributes += "<p>Your citizenship: "+attribute_citizenship;
%>
<html>
<head>
    <title>Voting for elections to the danish national parliament (Verifier)</title>
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Voting for elections to the danish national parliament (Verifier)</a>
        </div>
...
<div class="container">
    <div class="row">
        <div class="col-lg-6">
            <h1>Welcome to voting for elections to the danish national parliament</h1>
