...
<%
    ...
    String message = "Sorry, you have to be a danish citizenship to login at the danish tax authority.";

    if (attribute_citizenship != null && attribute_citizenship.toLowerCase().equals("danish")) {
        css = "success";
        headline = "Requirements fulfilled!";
        message = "You are now logged in at the danish tax authority.";
    }
